...
func NewRouter(c *RouterConfig) *gin.Engine {
	...
	repov1 := v1.Group("/repos")
	{
		...
		repov1.GET("/:namespace/:name/deployments/:number/comments", rm.RepoReadPerm(), r.ListComments)
		repov1.POST("/:namespace/:name/deployments/:number/comments", rm.RepoReadPerm(), r.CreateComment)
		repov1.GET("/:namespace/:name/deployments/:number/comments/:id", rm.RepoReadPerm(), r.GetComment)
