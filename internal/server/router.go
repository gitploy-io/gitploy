...
func NewRouter(c *RouterConfig) *gin.Engine {
	...
	repov1 := v1.Group("/repos")
	{
		...
		repov1.GET("/:id", rm.Repo(), r.GetRepo)
		repov1.PATCH("/:id", rm.Repo(), r.UpdateRepo)
		repov1.GET("/:id/commits", rm.Repo(), r.ListCommits)
		repov1.GET("/:id/commits/:sha", rm.Repo(), r.GetCommit)
		repov1.GET("/:id/commits/:sha/statuses", rm.Repo(), r.ListStatuses)
		repov1.GET("/:id/branches", rm.Repo(), r.ListBranches)
		repov1.GET("/:id/branches/:branch", rm.Repo(), r.GetBranch)
		repov1.GET("/:id/tags", rm.Repo(), r.ListTags)
		repov1.GET("/:id/tags/:tag", rm.Repo(), r.GetTag)
