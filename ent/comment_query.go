...
func (cq *CommentQuery) QueryDeployment() *DeploymentQuery {
...
func (cq *CommentQuery) WithDeployment(opts ...func(*DeploymentQuery)) *CommentQuery {
	query := &DeploymentQuery{config: cq.config}
	for _, opt := range opts {
		opt(query)
	}
