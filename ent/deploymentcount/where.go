...
func CreatedAt(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func UpdatedAt(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func CreatedAtEQ(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreatedAt), v))
	})
}
...
func CreatedAtNEQ(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func CreatedAtIn(vs ...time.Time) predicate.DeploymentCount {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedAtNotIn(vs ...time.Time) predicate.DeploymentCount {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedAtGT(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func CreatedAtGTE(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func CreatedAtLT(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func CreatedAtLTE(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func UpdatedAtEQ(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdatedAt), v))
	})
}
...
func UpdatedAtNEQ(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func UpdatedAtIn(vs ...time.Time) predicate.DeploymentCount {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedAtNotIn(vs ...time.Time) predicate.DeploymentCount {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedAtGT(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func UpdatedAtGTE(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func UpdatedAtLT(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
...
func UpdatedAtLTE(v time.Time) predicate.DeploymentCount {
	return predicate.DeploymentCount(func(s *sql.Selector) {
