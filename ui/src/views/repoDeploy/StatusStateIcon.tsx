...
export default function StatusStateIcon(
  props: StatusStateIconProps
): JSX.Element {
        ...
        return (
          <Row key={idx}>
            ...
            <Col span="11" style={{ textAlign: 'right' }}>
              <Link href={status.targetUrl} target="_blank">
                Details
              </Link>
            </Col>
  ...
  return (
    <Popover title="Statuses" trigger="click" content={content}>
...
function mergeStatusStates(states: StatusState[]): StatusState {
  ...
  for (let idx = 0; idx < states.length; idx++) {
    if (
      states[idx] === StatusState.Failure ||
