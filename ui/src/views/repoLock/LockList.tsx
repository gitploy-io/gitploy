        ...
        return lock ? (
          ...
          >
            <List.Item.Meta
              title={
                <span>
                  {env.name.toUpperCase()} <LockOutlined />
                </span>
              }
          ...
          >
            <List.Item.Meta
              title={
                <span>
                  {env.name.toUpperCase()} <UnlockOutlined />
                </span>
              }
              description={<LockDescription lock={lock} />}
            />
...
function LockDescription(props: LockDescriptionProps) {
  return props.lock ? (
    <span style={{ color: 'black' }}>
      Locked by <UserAvatar user={props.lock.user} />{' '}
      {moment(props.lock.createdAt).fromNow()}
    </span>
  ) : (
    <></>
  );
