  ...
  return (
    <Main>
      ...
      <div style={styleContent}>
        <div>{!tab || tab === 'home' ? <RepoHome /> : null}</div>
        <div>{tab === 'deploy' ? <RepoDeploy /> : null}</div>
        <div>{tab === 'rollback' ? <RepoRollabck /> : null}</div>
        <div>{tab === 'lock' ? <RepoLock /> : null}</div>
        <div>{tab === 'settings' ? <RepoSettings /> : null}</div>
      </div>
    </Main>
  );
}
