...
>('settings/fetchMe', async (_, { rejectWithValue }) => {
  try {
...
export const fetchRateLimit = createAsyncThunk<
  ...
  void,
  { state: { settings: SettingsState } }
>('settings/fetchRateLimit', async (_, { rejectWithValue }) => {
  try {
...
export const checkSlack = createAsyncThunk<
  boolean,
  void,
  { state: { settings: SettingsState } }
>('settings/checkSlack', async (_, { rejectWithValue }) => {
  try {
