    ...
    <List
      ...
      renderItem={(d) => {
        const title = d.repo
          ...
          : `Deployment #${d.number}`;
        const link = d.repo
          ? `/${d.repo.namespace}/${d.repo.name}/deployments/${d.number}`
          : `#`;
        ...
        return (
          <List.Item>
            <List.Item.Meta
              ...
              description={
                <Paragraph>
                  Deployed <DeploymentRefCode deployment={d} /> to the{' '}
                  <Text className="gitploy-code" code>
                    {d.env}
                  </Text>{' '}
                  environment {moment(d.createdAt).fromNow()}{' '}
      ...
      renderItem={(review) => {
        if (!review.deployment) {
          throw new ReferenceError(
            'The deployment of the review is not found.'
          );
        }
        ...
        return (
          <List.Item>
            <List.Item.Meta
              ...
              description={
                <Paragraph>
                  Requested the review to deploy{' '}
                  <DeploymentRefCode deployment={d} /> to the{' '}
                  <Text className="gitploy-code" code>
                    {d.env}
                  </Text>{' '}
                  environment {moment(d.createdAt).fromNow()}
